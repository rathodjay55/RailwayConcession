...
public class CollegeModel {
    ...
    String address,college,contact,from,name,pass_no,status,sap_id,duration,railwayClass;

    public CollegeModel() {
    }

    public CollegeModel(String address, String college, String contact, String from, String name, String pass_no, String status,String sap_id,String duration,String railwayClass) {
